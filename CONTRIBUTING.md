...
* [GitHub Issues](https://github.com/str20tbl/str20tbl/issues)
...
```
$ go get github.com/str20tbl/revel                        # Install Revel
$ cd $GOPATH/src/github.com/str20tbl/revel                # Change directory to revel repo
...
```
$ go test github.com/str20tbl/revel
```

Refer to the
[Travis configuration](https://github.com/str20tbl/str20tbl/blob/master/.travis.yml)
...
To develop the Jekyll site locally:
    ...
    $ git clone git@github.com:str20tbl/revel.github.io
    $ cd revel.github.io
...
[issues](https://github.com/str20tbl/str20tbl/issues?labels=contributor+ready&page=1&state=open).
