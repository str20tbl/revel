...
var (
	...
	ErrCacheMiss    = errors.New("str20tbl/cache: key not found")
	ErrNotStored    = errors.New("str20tbl/cache: not stored")
	ErrInvalidValue = errors.New("str20tbl/cache: invalid value")
)
